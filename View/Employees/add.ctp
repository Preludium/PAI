<div class="employees form">
	...
	<fieldset>
		...
		<?php
		$options = array('adiunkt' => 'adiunkt', 'asystent' => 'asystent', 'doktorant' => 'doktorant', 'dyrektor' => 'dyrektor', 'profesor' => 'profesor', 'sekretarka' => 'sekretarka');
		echo $this->Form->input('nazwisko');
		echo $this->Form->input('imie');
		echo $this->Form->input('etat', array('options' => $options));
